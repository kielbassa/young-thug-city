...
class Citizen:
    def __init__(self, tile, world, home_tile):
        ...
        self.at_work = False
        self.at_home = False  # Flag to track if citizen is at home during night
        ...
        self._find_home_road()
        
        # Find a factory to work at
        self._find_workplace()
        
        self.create_path()

    def _find_home_road(self):
